...
import { PeopleAlsoAskV2 } from './PeopleAlsoAskV2';

const meta: Meta<typeof PeopleAlsoAskV2> = {
  title: 'Blog/PeopleAlsoAskV2',
  component: PeopleAlsoAskV2,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component: `
# People Also Ask V2 - Neubrutalist FAQ Component
