...
interface EmailCaptureModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: AIAssessmentFormData) => void;
  isSubmitting?: boolean;
}

export const AIAssessmentModal: React.FC<EmailCaptureModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting = false,
  ...
  const handleFormSubmit = (data: AIAssessmentFormData) => {
    onSubmit(data);
  };
