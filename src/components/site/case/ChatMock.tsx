...
export function ChatMock() {
  return (
    <div className="flex w-full flex-col bg-white">
      {/* phone status bar */}
      <div className="flex items-center justify-between bg-black px-5 pb-1 pt-2 text-white">
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="max-w-[88%] overflow-hidden rounded-2xl rounded-bl-md bg-white shadow-sm ring-1 ring-black/5">
              <div className="flex items-center justify-between bg-zinc-900 px-3.5 py-2 text-white">
                ...
                <span className="text-[15px] font-bold text-[#E4C77A]">
                  £249
                </span>
              </div>
              ...
              <ul className="space-y-1.5 px-3.5 py-3 text-[12px] text-zinc-600">
                <li className="flex gap-2">
                  <Tick /> machine polish to lift the swirls
                </li>
                <li className="flex gap-2">
                  <Tick /> full interior deep clean
                </li>
                <li className="flex gap-2">
                  <Tick /> protective seal
                </li>
              </ul>
            </div>
          </div>
...
function Tick() {
  return (
    <svg
      viewBox="0 0 24 24"
      className="mt-0.5 h-3.5 w-3.5 flex-shrink-0 text-[#9A7B2E]"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.5"
      strokeLinecap="round"
