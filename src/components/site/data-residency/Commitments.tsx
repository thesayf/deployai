...
export function Commitments() {
  return (
    <section className="bg-navy commit" id="commitments">
      <div className="wrap">
        <h2>
        ...
        <div className="cite">
          <p>
            ...
            thirty days, and zero-retention is available for workloads where even
            that is too long.
          </p>
        </div>
        <p className="close">
          Every line here is Anthropic&rsquo;s written policy, verifiable on its
          own privacy pages at privacy.claude.com, something your compliance team
          can read for themselves. And when the model runs inside your own cloud,
          retention is governed by your policies, not ours.
        </p>
      </div>
    </section>
  );
