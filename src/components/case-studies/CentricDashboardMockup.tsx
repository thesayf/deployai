        ...
        <div className="relative bg-zinc-900 rounded-t-2xl p-1 shadow-2xl">
          ...
          <div className="bg-zinc-950 rounded-t-xl p-4">
            ...
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
              ...
              {/* Dashboard Interface - Desktop Screenshot View */}
              <div className="bg-white h-[500px] relative overflow-hidden">
                {/* App Header - Minimal */}
                <div className="bg-gradient-to-r from-purple-700 to-purple-600 text-white px-2 py-1 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs bg-yellow-500 text-black px-1 py-0.5 rounded">Live</span>
                ...
                <div className="px-2 py-1 border-b border-zinc-200 bg-zinc-50 flex items-center gap-2">
                  <div className="flex-1 bg-white rounded px-2 py-1 text-xs border flex items-center gap-1">
                    <svg className="w-3 h-3 text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    <span className="text-zinc-500">Youth engagement Birmingham</span>
                  </div>
                  <button className="bg-purple-600 text-white px-3 py-1 rounded text-xs">Search</button>
                  <button className="text-zinc-500 hover:text-purple-600 px-2 py-1 text-xs">Filter</button>
                </div>
                  ...
                  <div className="flex-1 p-1">
                    <div className="flex justify-between items-center mb-1">
                      <div className="flex gap-1">
                        <button className="bg-purple-100 text-purple-700 px-2 py-0.5 rounded text-xs">Projects (8)</button>
                        <button className="text-zinc-500 hover:text-purple-600 px-2 py-0.5 rounded text-xs">Partners (12)</button>
                      </div>
                      <div className="flex gap-1 text-xs">
                        <button className="bg-purple-100 text-purple-700 px-1 py-0.5 rounded text-xs">Grid</button>
                    ...
                    <div className="space-y-2 pb-2">
                      <div className="bg-white rounded border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative" style={{padding: '10px', marginBottom: '8px'}}>
                        ...
                        <div style={{marginBottom: '6px'}}>
                          <span className="bg-purple-100 text-purple-800 px-2 py-0.5 rounded text-xs">Youth</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center">
                          <span className="bg-green-100 text-green-700 px-3 py-1 rounded text-xs">Strong Contact</span>
                      ...
                      <div className="bg-white rounded border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative" style={{padding: '10px', marginBottom: '8px'}}>
                        ...
                        {/* Top Row: Category Tag */}
                        <div style={{marginBottom: '6px'}}>
                          <span className="bg-green-100 text-green-800 px-2 py-0.5 rounded text-xs">Health</span>
                        </div>
                        ...
                        {/* Bottom Row: Relationship Badge + View Button */}
                        <div className="flex justify-between items-center">
                          <span className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded text-xs">Warm Intro</span>
                          <button className="text-purple-600 hover:text-purple-800 text-xs">View</button>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative" style={{padding: '10px', marginBottom: '8px'}}>
                        ...
                        {/* Top Row: Category Tag */}
                        <div style={{marginBottom: '6px'}}>
                          <span className="bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded text-xs">Digital</span>
                        </div>
                      ...
                      <div className="bg-white rounded border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative" style={{padding: '10px', marginBottom: '8px'}}>
                        ...
                        {/* Top Row: Category Tag */}
                        <div style={{marginBottom: '6px'}}>
                          <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded text-xs">Env</span>
                        </div>
                      ...
                      <div className="bg-white rounded border border-zinc-200 shadow-sm hover:shadow-md transition-shadow relative" style={{padding: '10px', marginBottom: '8px'}}>
                        ...
                        {/* Top Row: Category Tag */}
                        <div style={{marginBottom: '6px'}}>
                          <span className="bg-orange-100 text-orange-800 px-2 py-0.5 rounded text-xs">Ed</span>
                        </div>
                        ...
                        {/* Bottom Row: Relationship Badge + View Button */}
                        <div className="flex justify-between items-center">
                          <span className="bg-red-100 text-red-700 px-3 py-1 rounded text-xs">Cold Outreach</span>
                          <button className="text-purple-600 hover:text-purple-800 text-xs">View</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="text-center pt-4 border-t border-zinc-200">
                      <button className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-xs hover:bg-purple-200 transition-colors">
