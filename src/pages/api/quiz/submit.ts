    ...
    if (tenantContext && tenantContext.tenant.contact_email) {
      try {
        ...
        sendAssessmentCompletedNotification({
          ...
          companyName: tenantContext.tenant.company_name,
          candidateFirstName: (quizData as any).first_name,
          candidateLastName: (quizData as any).last_name,
          candidateEmail: (quizData as any).email,
          candidateCompany: (quizData as any).company,
