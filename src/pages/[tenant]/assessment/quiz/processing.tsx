...
const TenantProcessingPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Generating Your Report | {tenantContext?.tenant.company_name || 'AI Assessment'}</title>
      </Head>
        ...
        <div className="max-w-2xl w-full text-center">
          ...
          {error ? (
            <>
              ...
              <button
                onClick={() => router.push(`/${tenant}/assessment`)}
...
export default TenantProcessingPage;
